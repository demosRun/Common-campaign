...
(function (window) {
  ...
  ElastiStack.prototype._init = function () {
    // items
    this.items = [].slice.call(this.container.children); // 当前卡片索引
  ...
  ElastiStack.prototype._moveAway = function (instance) {
    ...
    // 判断是否有下一个卡片
    var next = this.items[this.current + 1];
    ...
    this._disableDragg(); // add class "animate"


    classie.add(instance.element, 'animate'); // calculate how much to translate in the x and y axis
